 ...
 * 
 */
public class EnhancedBuildingLayer extends AreaLayer<Building> {
	...
	protected void paintEdge(Edge e, Graphics2D g, ScreenTransform t) {
		...
		g.drawLine(t.xToScreen(e.getStartX()), t.yToScreen(e.getStartY()), t
				.xToScreen(e.getEndX()), t.yToScreen(e.getEndY()));
	}
	...
	private void drawFieryness(Building b, Polygon shape, Graphics2D g) {
		...
		default:
			throw new IllegalArgumentException(
					"Don't know how to render fieryness "
							+ b.getFierynessEnum());
		}
		g.fill(shape);
	}
